...
+------------------------------------------------------+
|                Application Layer                     |
|           (User Message via Serial Monitor)          |
+------------------------------------------------------+
                        |
                        v
+------------------------------------------------------+
|                  Encoding Layer                      |
|     ASCII -> Binary -> Framing -> Checksum Add        |
+------------------------------------------------------+
                        |
                        v
+------------------------------------------------------+
...
+------------------------------------------------------+
                        ...
                        v
+------------------------------------------------------+
|                LED Transmitter (GPIO)                |
+------------------------------------------------------+
                        |
                  Visible Light
                        |
+------------------------------------------------------+
|            Photodiode Receiver (Analog A0)           |
+------------------------------------------------------+
                        |
                        v
+------------------------------------------------------+
|               Demodulation + Thresholding            |
+------------------------------------------------------+
                        |
                        v
+------------------------------------------------------+
|         Frame Validation + Checksum + ACK            |
+------------------------------------------------------+
                        |
                        v
+------------------------------------------------------+
